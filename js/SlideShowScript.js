...
// when the user clicks on (x), close the images container
...
function mountains() {
    ...
    document.getElementById('slideShowPhotoPreview1').src="images/slideshow/mountains/badullaPreview.jpg";
    ...
    document.getElementById('slideShowPhoto2').src="images/slideshow/mountains/kallebokka.jpg";
    document.getElementById('slideShowPhotoPreview2').src="images/slideshow/mountains/kallebokkaPreview.jpg";
    ...
    document.getElementById('slideShowPhoto3').src="images/slideshow/mountains/kallebokka2.jpg";
    document.getElementById('slideShowPhotoPreview3').src="images/slideshow/mountains/kallebokka2Preview.jpg";
    document.getElementById('slideShowPhotoPreview3').alt="Another magnificent photo captured at the Kallebokka viewpoint ";

    document.getElementById('slideShowPhoto4').src="images/slideshow/mountains/knuckles.jpg";
    document.getElementById('slideShowPhotoPreview4').src="images/slideshow/mountains/knuckclesPreview.jpg";
    document.getElementById('slideShowPhotoPreview4').alt="Misty mountains in Knuckles";

    document.getElementById('slideShowPhoto5').src="images/slideshow/mountains/badulla2.jpg";
    document.getElementById('slideShowPhotoPreview5').src="images/slideshow/mountains/badulla2Preview.jpg";
    document.getElementById('slideShowPhotoPreview5').alt="Avalanche of mist falling through the mountains of Matale";

    document.getElementById('slideShowPhoto6').src="images/slideshow/mountains/riverston.jpg";
    document.getElementById('slideShowPhotoPreview6').src="images/slideshow/mountains/riverstonPreview.jpg";
...
function beaches() {
    document.getElementById('slideShowPhoto1').src="images/slideshow/beaches/dondaraBeach2.jpg";
    document.getElementById('slideShowPhotoPreview1').src="images/slideshow/beaches/dondaraBeach2Preview.jpg";
    document.getElementById('slideShowPhotoPreview1').alt="A Mighty lighthouse captured at Dondara Beach";

    document.getElementById('slideShowPhoto2').src="images/slideshow/beaches/dondaraBeach.jpg";
    document.getElementById('slideShowPhotoPreview2').src="images/slideshow/beaches/dondaraBeachPreview.jpg";
    document.getElementById('slideShowPhotoPreview2').alt="Epic scenario caught at Dondara Beach";

    document.getElementById('slideShowPhoto3').src="images/slideshow/beaches/rannaBeach.jpg";
    document.getElementById('slideShowPhotoPreview3').src="images/slideshow/beaches/rannaBeachPreview.jpg";
    ...
    document.getElementById('slideShowPhoto4').src="images/slideshow/beaches/tangalleBeachjpg.jpg";
    document.getElementById('slideShowPhotoPreview4').src="images/slideshow/beaches/tangalleBeachPreview.jpg";
    document.getElementById('slideShowPhotoPreview4').alt="Southern coast of Sri Lanka, Captured at Weligama";

    document.getElementById('slideShowPhoto5').src="images/slideshow/beaches/dondaraBeach4.jpg";
    document.getElementById('slideShowPhotoPreview5').src="images/slideshow/beaches/dondaraBeach4Preview.jpg";
    document.getElementById('slideShowPhotoPreview5').alt="Beautiful sunset captured at Dondara Beach";

    document.getElementById('slideShowPhoto6').src="images/slideshow/beaches/dondaraBeach3.jpg";
    document.getElementById('slideShowPhotoPreview6').src="images/slideshow/beaches/dondaraBeach3Preview.jpg";
...
function forests() {
    document.getElementById('slideShowPhoto1').src="images/slideshow/forests/ramboda.jpg";
    document.getElementById('slideShowPhotoPreview1').src="images/slideshow/forests/rambodaPreview.jpg";
    document.getElementById('slideShowPhotoPreview1').alt="Beautiful scenario which can be caught at Ramboda State";

    document.getElementById('slideShowPhoto2').src="images/slideshow/forests/kadiyanlena.jpg";
    document.getElementById('slideShowPhotoPreview2').src="images/slideshow/forests/kadiyanlenaPreview.jpg";
    document.getElementById('slideShowPhotoPreview2').alt="Fascinating waterfall that you can find in Kadiyangala";

    document.getElementById('slideShowPhoto3').src="images/slideshow/forests/narampanawa.jpg";
    document.getElementById('slideShowPhotoPreview3').src="images/slideshow/forests/narampanawaPreview.jpg";
    ...
    document.getElementById('slideShowPhoto4').src="images/slideshow/forests/riverston.jpg";
    document.getElementById('slideShowPhotoPreview4').src="images/slideshow/forests/riverstonPreview.jpg";
    document.getElementById('slideShowPhotoPreview4').alt="Another beautiful waterfall captured at Riverston";

    document.getElementById('slideShowPhoto5').src="images/slideshow/forests/kallebokka.jpg";
    document.getElementById('slideShowPhotoPreview5').src="images/slideshow/forests/kallebokkaPreview.jpg";
    document.getElementById('slideShowPhotoPreview5').alt="Kallebokka view point with a majestic sunset";

    document.getElementById('slideShowPhoto6').src="images/slideshow/forests/knuckles.jpg";
    document.getElementById('slideShowPhotoPreview6').src="images/slideshow/forests/knucklesPreview.jpg";
...
function culture() {
    document.getElementById('slideShowPhoto1').src="images/slideshow/culture/sigiriya.jpg";
    document.getElementById('slideShowPhotoPreview1').src="images/slideshow/culture/sigiriyaPreview.jpg";
    document.getElementById('slideShowPhotoPreview1').alt="Majestic Sigiriya rock on a beautiful morning";

    document.getElementById('slideShowPhoto2').src="images/slideshow/culture/perahera.jpg";
    document.getElementById('slideShowPhotoPreview2').src="images/slideshow/culture/peraheraPreview.jpg";
    document.getElementById('slideShowPhotoPreview2').alt="Beautiful shot caught at Kandy Esala Perahera";

    document.getElementById('slideShowPhoto3').src="images/slideshow/culture/fishermen.jpg";
    document.getElementById('slideShowPhotoPreview3').src="images/slideshow/culture/fishermenPreview.jpg";
    document.getElementById('slideShowPhotoPreview3').alt="Group of fishermen starting their day at dawn";

    document.getElementById('slideShowPhoto4').src="images/slideshow/culture/mask.jpg";
    document.getElementById('slideShowPhotoPreview4').src="images/slideshow/culture/maskPreview.jpg";
    document.getElementById('slideShowPhotoPreview4').alt="Unique kind of cravings that can be found in Ambalangoda";

    document.getElementById('slideShowPhoto5').src="images/slideshow/culture/dalada.jpg";
    document.getElementById('slideShowPhotoPreview5').src="images/slideshow/culture/daladaPreview.jpg";
    document.getElementById('slideShowPhotoPreview5').alt="Temple of Tooth otherwise known as Heart of the up-country, Sri Lanka";

    document.getElementById('slideShowPhoto6').src="images/slideshow/culture/dancers.jpg";
    document.getElementById('slideShowPhotoPreview6').src="images/slideshow/culture/dancersPreview.jpg";
...
function oldKingdom() {
    document.getElementById('slideShowPhoto1').src="images/slideshow/oldKingdom/galleFort.jpg";
    document.getElementById('slideShowPhotoPreview1').src="images/slideshow/oldKingdom/galleFortPreview.jpg";
    ...
    document.getElementById('slideShowPhoto2').src="images/slideshow/oldKingdom/dambulla.jpg";
    document.getElementById('slideShowPhotoPreview2').src="images/slideshow/oldKingdom/dambullaPreview.jpg";
    ...
    document.getElementById('slideShowPhoto3').src="images/slideshow/oldKingdom/adamsPeak.jpg";
    document.getElementById('slideShowPhotoPreview3').src="images/slideshow/oldKingdom/adamsPeakPreview.jpg";
    ...
    document.getElementById('slideShowPhoto4').src="images/slideshow/oldKingdom/ruwanweliseya.jpg";
    document.getElementById('slideShowPhotoPreview4').src="images/slideshow/oldKingdom/ruwanweliseyaPreview.jpg";
    ...
    document.getElementById('slideShowPhoto5').src="images/slideshow/oldKingdom/kuttamPokuna.jpg";
    document.getElementById('slideShowPhotoPreview5').src="images/slideshow/oldKingdom/kuttamPokunaPreview.jpg";
    ...
    document.getElementById('slideShowPhoto6').src="images/slideshow/oldKingdom/galWiharaya.jpg";
    document.getElementById('slideShowPhotoPreview6').src="images/slideshow/oldKingdom/galWiharayaPreview.jpg";
    document.getElementById('slideShowPhotoPreview6').alt="This is a group of beautiful Buddha images that probably marks the high point of Sinhalese" +
        "rock carving. They are part of Parakramabahu I’s northern monastery. The Gal Vihara consists of four separate images, all cut from one long slab of granite." +
